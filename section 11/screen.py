...
radio3 = tkinter.Radiobutton(optionFrame, text="Timestamp", value=2, variable=rbValue)
...
monthSpin = tkinter.Spinbox(dateFrame, width=5, values=("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Dec"))
